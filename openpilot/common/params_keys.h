...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"ReverseDriverCamera", {PERSISTENT, BOOL, "0"}},
    {"ReverseDriverCameraNexoMigrated", {PERSISTENT, BOOL, "0"}},
    ...
    {"ClusterHudSideCamera", {PERSISTENT, INT, "0"}},
    {"ClusterHudSideCameraTrigger", {PERSISTENT, INT, "2"}},
    {"ClusterHudSideCameraPreview", {PERSISTENT, INT, "0"}},
    {"ClusterHudSideCameraLeftX", {PERSISTENT, INT, "25"}},
    ...
    {"NexoExperimentalSwitchSpeed", {PERSISTENT, INT, "20"}},
